...
export default function Home() {
  return (
    <main className="flex flex-col items-center gap-8 mt-16">
      ...
      <div className="">
        I&apos;m a 3rd year student at the <Anchor link="https://www.giu-uni.de/" text="German International University" /> in Cairo, Egypt. My true
        passion for technology, web development, and tech, in general, has led me to choose to pursue my career in software engineering.
      </div>
      ...
      <div>
        I am exploring the world of fullstack development and I love having the ability of crafting beautiful and functional web applications. I am
        now building web applications harnessing the <Technology logo={next} text="Next.js" /> framework and it has been a great developer experience
        so far. I also love randomly solving leetcode problems at 3AM using <Technology logo={java} text="Java" />, the best OOP language out there in
        my humble opinion.
      </div>
      ...
      <div>Over the years I have used many technologies, frameworks, and languages. Below are some of the technologies that I regularly use:</div>
